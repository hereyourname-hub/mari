package com.example.bodyboost.Helpers;
...
public class TimeFormatting {
    ...
    public static String localDateToString(LocalDate localDate) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            dateFormat = DateTimeFormatter.ofPattern("MM/dd/yyyy", Locale.getDefault());
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void getCurrentTimeAndDate(TextView date, TextView time) {
        ...
        SimpleDateFormat dateForDb = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            dateForDb = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault());
        }
    ...
    public static String localDateTimeToString(LocalDateTime localDateTime) {
        DateTimeFormatter dateFormat = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            dateFormat = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss", Locale.getDefault());
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
