package com.example.bodyboost.SimpleClasses;

import static com.example.bodyboost.AddMedication.MINUTES_IN_DAY;
    ...
    public String generateFrequencyLabel(Context applicationContext) {
        ...
        if (getFrequency() == MINUTES_IN_DAY && (getTimes().length == 1)) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                time = TimeFormatting.localTimeToString(getTimes()[0].toLocalTime());
            }
